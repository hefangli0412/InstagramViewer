//
//  HFCollectionHomeViewController.m
//  Hefang
//
...
#import "HFSmallGalleryViewController.h"
#import "HFPhotoController.h"
#import "HFSmallImageCell.h"
#import "HFConstants.h"

@interface HFSmallGalleryViewController ()
@property (nonatomic, strong) NSArray *posts;
@property (nonatomic, strong) UIView *whitepage;
@property (nonatomic) BOOL hasConnectionError;
@end

@implementation HFSmallGalleryViewController
...
- (void)setImageForCell:(HFSmallImageCell*)cell post:(NSDictionary*)post resolution:(HFImageResolution)resolution {
...
- (HFSmallImageCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    HFSmallImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kSmallGalleryCellIdentifier forIndexPath:indexPath];
